package com.example.consumerbill.cores.payment_util;
...
public class PaymentsUtil {
     ...
     * environment and theme set in {@link ConstRef}.
     *
     * @param context is the caller's context.
     */
    public static PaymentsClient createPaymentsClient(Context context) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(ConstRef.PAYMENTS_ENVIRONMENT).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        JSONObject parameters = new JSONObject(ConstRef.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(ConstRef.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(ConstRef.SUPPORTED_METHODS);
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", ConstRef.COUNTRY_CODE);
        transactionInfo.put("currencyCode", ConstRef.CURRENCY_CODE);
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(ConstRef.SHIPPING_SUPPORTED_COUNTRIES);
